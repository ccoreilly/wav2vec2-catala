...
processor = Wav2Vec2Processor.from_pretrained("wav2vec2-large-xlsr-catala-1/checkpoint-193000")
model = Wav2Vec2ForCTC.from_pretrained("wav2vec2-large-xlsr-catala-1/checkpoint-193000")
model.to("cuda")
